...
<!--Header del sistema - - - - - - - - - - - - - - - - - - - - -  - - - - - - - - - -  - - - -  - - - - - - -->
  <div id="content" class="app-content" role="main">
    ...
    <div class="navbar md-whiteframe-z1 no-radius blue">
      ...
      <!-- / -->
      <!-- Titulo de la página -->
      <div class="navbar-item pull-left h4">Back Order</div>
      <!-- /Titulo de la página -->
...
<!--  Sección de Tabla de Documentos - - - - - - - - - -  - - - - - - - - - - -  - - - - - - - - - - - - -->
      <div class="col-lg-9 col-md-12 col-sm-12">
            <div class="panel panel-default">
              <div class="panel-heading"><h4>Back Order <?php echo date('d/m/Y'); ?></h4></div>
              <table class="table table-striped " >
                ...
                <tbody class="table-hover">
                  <?php 
                      ...
                      $Consulta_Nuevas_Ordenes ="SELECT T0.[DocNum], T0.[CardName], sum(T1.[TotalSumSy]), sum(T1.[TotalSumSy]) * T1.[VatPrcnt] /100, sum(T1.[TotalSumSy]) +  sum(T1.[TotalSumSy]) * T1.[VatPrcnt]/100 FROM ORDR T0  INNER JOIN RDR1 T1 ON T0.DocEntry = T1.DocEntry INNER JOIN OSLP T2 ON T0.SlpCode = T2.SlpCode WHERE T2.[U_CODIGO_USA] = ".$_SESSION['Usuario_Actual']." AND  T0.[DocDate] = '".date("Y/m/d")."' AND T1.[OpenQty] <> 0 GROUP BY T0.[DocNum],T0.[CardName], T1.[VatPrcnt]";
